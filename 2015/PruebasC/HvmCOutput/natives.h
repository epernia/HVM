...
#define N_JAVA_LANG_DOUBLE_DOUBLETORAWLONGBITS_NUM 48
int16 n_java_lang_Double_doubleToRawLongBits(int32 *sp);

#define N_JAVA_LANG_DOUBLE_LONGBITSTODOUBLE_NUM 49
int16 n_java_lang_Double_longBitsToDouble(int32 *sp);

#define N_JAVA_LANG_FLOAT_FLOATTORAWINTBITS_NUM 50
int16 n_java_lang_Float_floatToRawIntBits(int32 *sp);

#define N_JAVA_LANG_OBJECT_GETCLASS_NUM 51
int16 n_java_lang_Object_getClass(int32 *sp);

#define N_JAVA_LANG_SYSTEM_ARRAYCOPY_NUM 52
int16 n_java_lang_System_arraycopy(int32 *sp);

#define N_JAVA_LANG_SYSTEM_REGISTERNATIVES_NUM 53
int16 n_java_lang_System_registerNatives(int32 *sp);

#define N_JAVA_LANG_THROWABLE_CLINIT__NUM 54
int16 n_java_lang_Throwable_clinit_(int32 *sp);

#define N_JAVA_LANG_THROWABLE_FILLINSTACKTRACE__NUM 55
int16 n_java_lang_Throwable_fillInStackTrace_(int32 *sp);

#define N_JAVA_LANG_REFLECT_ARRAY_NEWARRAY_NUM 56
int16 n_java_lang_reflect_Array_newArray(int32 *sp);

#define N_VM_PROCESS_EXECUTEWITHSTACK_NUM 57
int16 n_vm_Process_executeWithStack(int32 *sp);

#define N_VM_PROCESS_TRANSFER_NUM 58
int16 n_vm_Process_transfer(int32 *sp);

#define N_VM_REALTIMECLOCK_AWAITNEXTTICK_NUM 59
int16 n_vm_RealtimeClock_awaitNextTick(int32 *sp);

#define N_VM_REALTIMECLOCK_GETNATIVERESOLUTION_NUM 60
int16 n_vm_RealtimeClock_getNativeResolution(int32 *sp);

#define N_VM_REALTIMECLOCK_GETNATIVETIME_NUM 61
