...
public class FieldOffsetCalculator {
            ...
            if (!fields[i].isStatic()) {
                ...
                if (includeClassFields) {
                    if (observer.isClassFieldUsed(clazz.getClassName(), fieldName)) {
                        ...
                        offset += fieldSize;
                        handleFieldAttributes(observer, clazz.getClassName(), fieldOffset, fields[i], fInfo);
                    }
                }
            }
        }
    ...
    private void handleFieldAttributes(AnalysisObserver observer, String containingClass, int fieldOffset, Field field, FieldInfo fInfo) {
        ...
        for (Attribute attribute : attributes) {
            if (attribute instanceof AnnotationsAttribute) {
                ...
                if (cvar != null) {
                    observer.registerNativeField(containingClass, fieldOffset, fInfo, cvar);
                }
            }
