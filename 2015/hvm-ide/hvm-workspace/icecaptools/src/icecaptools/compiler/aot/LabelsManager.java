...
public class LabelsManager {
    ...
    public void generateThrowClassCast() throws Exception {
        if (!labels.containsKey(LThrowClassCast)) {
            ...
            spManipulator.setSPUsed(true);
            throwClassCast.append("      initializeException(sp, JAVA_LANG_CLASSCASTEXCEPTION, JAVA_LANG_CLASSCASTEXCEPTION_INIT_);\n");
            throwClassCast.append("      excep = JAVA_LANG_CLASSCASTEXCEPTION;\n");
            labels.put(LThrowClassCast, throwClassCast);
            requiredIncludes.print("void initializeException(int32* sp, int16 exceptionClass, int16 exceptionInitMethod);\n");
    ...
    public void generateThrowNullPointer() throws Exception {
        if (!labels.containsKey(LThrowNullPointer)) {
            ...
            spManipulator.setSPUsed(true);
            throwNullPointer.append("      initializeException(sp, JAVA_LANG_NULLPOINTEREXCEPTION, JAVA_LANG_NULLPOINTEREXCEPTION_INIT_);\n");
            throwNullPointer.append("      excep = JAVA_LANG_NULLPOINTEREXCEPTION;\n");
    ...
    public void generateOutOfMemory() throws Exception {
        if (!labels.containsKey(LThrowOutOfMemory)) {
            ...
            spManipulator.setSPUsed(true);
            throwOutOfMemory.append("      initializeException(sp, JAVA_LANG_OUTOFMEMORYERROR, JAVA_LANG_OUTOFMEMORYERROR_INIT_);\n");
            throwOutOfMemory.append("      excep = JAVA_LANG_OUTOFMEMORYERROR;\n");
    ...
    public void generateArithmeticException() throws Exception {
        if (!labels.containsKey(LThrowArithmeticException)) {
            ...
            spManipulator.setSPUsed(true);
            throwArithmetic.append("      initializeException(sp, JAVA_LANG_ARITHMETICEXCEPTION, JAVA_LANG_ARITHMETICEXCEPTION_INIT_);\n");
            throwArithmetic.append("      excep = JAVA_LANG_ARITHMETICEXCEPTION;\n");
